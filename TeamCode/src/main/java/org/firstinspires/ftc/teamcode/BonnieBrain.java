...
@TeleOp(name="BonnieBrain", group="DriveModes")
public class BonnieBrain extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        // Claw extension
        CRServo extension = hardwareMap.get(CRServo.class, "extension");
        // Claw Motors
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            double frontRightPower = mult *  (y + x - rx) / denominator;
            double backRightPower = mult *  (y - x - rx) / denominator;
