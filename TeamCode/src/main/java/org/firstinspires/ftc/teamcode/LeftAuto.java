...
public class LeftAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            bot.raiseExtension(300, extension);
            //extension.setPower(1);
            sleep(10000);
            //bot.strafeRight(5, 2200, frontRight, frontLeft, backRight, backLeft);
            //bot.strafeLeft(5,400, frontRight, frontLeft, backRight, backLeft);
            //bot.driveForward(5,800, frontRight, frontLeft, backRight, backLeft);
            //bot.closeClaw(leftClaw, rightClaw);
